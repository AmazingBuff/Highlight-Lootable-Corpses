...
// Vendored from QuickLootIE 3.4.0 (include/QuickLootAPI.h) for dual-protocol
// support: QLIE >= 4.0 exposes GetQuickLootInterfaceV20/V21 C exports, while
// 3.x talks PluginRequests over the SKSE messaging interface.
// Renamed from QuickLoot to QuickLoot34: both headers declare
// QuickLoot::Events::OpeningLootMenuEvent with INCOMPATIBLE layouts (3.4's is
// a raw TESObjectREFR*, 4.0's an ObjectRefHandle), so they must never merge.
