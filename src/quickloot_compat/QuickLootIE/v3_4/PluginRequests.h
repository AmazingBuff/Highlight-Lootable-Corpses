...
// Vendored from QuickLootIE 3.4.0 (include/PluginRequests/PluginRequests.h).
// Message types and constants for the PluginRequests protocol: SKSE
// messaging messages of type 'XVER'/'XQRY'/'XARR' carry version handshakes
// and query payloads between plugins.
