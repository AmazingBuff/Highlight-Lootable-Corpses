...
// Vendored from QuickLootIE 3.4.0 (include/PluginRequests/RequestServer.h).
// Server side is NOT used by this plugin — QuickLootIE itself runs the server.
// Kept only to keep the vendored trio self-contained; the linker discards the
